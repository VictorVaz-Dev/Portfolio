...
export interface CarouselItem {
  ...
  buttons?: {
    label: string;
    icon?: JSX.Element;  // adicionada propriedade icon para o botão
    onClick: () => void;
...
const DEFAULT_ITEMS: CarouselItem[] = [
  ...
  // os outros itens seguem igual, mas você pode adicionar icons se quiser
];
...
export default function Carousel({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative bg-black mt-[4vh] overflow-hidden p-4 ${
        round
