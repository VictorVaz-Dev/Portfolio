...
export const Skills = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-[6vh] mb-[10vh]" id="skills">
            <h1 className="flex flex-col justify-center items-center text-[3.5rem] text-white font-semibold  mb-[6vh]">{t("skills.skills")}<RotatingText
                texts={['Front-end', 'Data', 'Backend']}
