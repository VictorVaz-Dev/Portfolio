        ...
        <div className="flex flex-col justify-center items-center mt-[6vh] mb-[10vh]" id="skills">
            ...
            <div className="flex justify-center items-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-white">
                    <div className="relative w-[400px] p-4 rounded-lg border-2 border-[#33cccc] shadow-[0_0_20px_#33ccccff] animate-bounce bg-gray-900 text-white font-semibold flex justify-center items-center">
